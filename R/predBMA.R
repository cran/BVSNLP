...
#' @param X The \code{n} times \code{p} design matrix. It should be in the same
#' scale as the input to \code{bvs} function. In particular, if preprocessing
#' has been done via \code{bvs} function for the design matrix, this input
#' should be the output of \code{PreProcess} function. Also note that For
#' binary data, \code{X} should NOT contain vector of \code{1}'s.
